...
<body style="margin: 40px;">
	...
	<table border="1">
		...
		<tr><td>\${"10" + 1}</td><td>${"10" + 1}</td></tr> <%-- + 연산자는 오로지 숫자에서만 적용됨 --%>
		...
		<tr><td>\${20 == 10}</td><td>${20 == 10}</td></tr>
		<tr><td>\${20 eq 10}</td><td>${20 eq 10}</td></tr> <%-- equal --%>
		<tr><td>\${20 ne 10}</td><td>${20 ne 10}</td></tr> <%-- not equal --%>
	...
	<h3>사례</h3>
	<ul>
		<li>파라메타 값은 ${empty param.num ? '입력하지 않았음' : param.num} 입니다.</li>
		<li><a class="nav-link ${menu eq 'board' ? 'active' : ''}" href="#">게시판</a></li>
		<%-- <li><a class="nav-link " href="#">Active</a></li> menu가 board면 active가 소스보기에서 안나옴.--%>
	</ul>
</body>
</html>