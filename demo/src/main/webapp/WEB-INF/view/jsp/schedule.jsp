		...
		<div class="row">
			...
			<div class="col-9">
				...
				<div class="d-flex justify-content-between">
					...
					<div>
						<a href="#"><i class="fa-solid fa-angles-left"></i></a> <a
							href="#"><i class="fa-solid fa-angle-left ms-2"></i></a> <span
							class="badge bg-primary mx-2">2023.03</span> <a href="#"><i
							class="fa-solid fa-angle-right me-2"></i></a> <a href="#"><i
							class="fa-solid fa-angles-right"></i></a>
					</div>
					<div>
						<a href="#"><i class="fa-solid fa-pen me-3"></i></a> <a href="#"><i
							class="fa-solid fa-table-list"></i></a>
					</div>
				</div>
					...
					<tr>
						...
						<td>
							...
							<div class="mt-1" style="font-size: 12px;">
								<strong>12:00 케냐방문</strong><br> 18:00 귀가
							</div>
						</td>
